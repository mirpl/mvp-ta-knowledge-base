...
5. If you see the commits, displayed in the Test details, you can use the Test to build a new [Test Plan](../Test Plan/Test Plan.md). The Test Plan can be Parallel or Sequential - it’s up to you!
